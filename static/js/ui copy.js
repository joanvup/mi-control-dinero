const ui = {
    ...
    // Gráficos (instancias de Chart.js)
    charts: {},
     ...
     * @param {object} summary - { total_income, total_expense, total_balance }
     */
    ...
    renderCharts: (chartData) => {
        ...
        ui.charts.incomeVsExpense = new Chart(incomeVsExpenseCtx, {
            type: 'bar',
            data: {
                labels: chartData.income_vs_expense.labels,
                datasets: [
                    {
                        label: 'Ingresos',
                        data: chartData.income_vs_expense.income,
                    ...
                    {
                        label: 'Gastos',
                        data: chartData.income_vs_expense.expense,
        ...
        ui.charts.expenseDistribution = new Chart(expenseDistributionCtx, {
            type: 'doughnut',
            data: {
                labels: chartData.expense_distribution.labels,
                datasets: [{
                    data: chartData.expense_distribution.data,
     ...
     * @param {string} formHtml - Contenido HTML del formulario.
    ...
    showModal: (title, formHtml, onSubmit) => {
        ...
        const closeModal = () => {
            ...
            setTimeout(() => modalContainer.innerHTML = '', 300); // Limpiar después de la transición
        };
    ...
    /**
     * Genera el HTML para el formulario de transacción.
    ...
    getTransactionFormHtml: (type, sources) => {
        ...
        return `
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="description" name="description" type="text" required>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="amount">Monto</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="amount" name="amount" type="number" step="0.01" required>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="source_id">Fuente</label>
                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="source_id" name="source_id" required>
                    ${sourceOptions}
                </select>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="category">Categoría</label>
                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="category" name="category" required>
                    ${categoryOptions}
                </select>
            </div>
        `;
    ...
    /**
     * Genera el HTML para el formulario de transferencia.
     * @param {Array<object>} sources
     * @returns {string}
     */
    getTransferFormHtml: (sources) => {
        ...
        return `
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="from_source_id">Desde</label>
                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="from_source_id" name="from_source_id" required>
                    ${sourceOptions}
                </select>
            </div>
             <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="to_source_id">Hacia</label>
                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="to_source_id" name="to_source_id" required>
                    ${sourceOptions}
                </select>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="description">Descripción</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="description" name="description" type="text" placeholder="Ej: Ahorros mensuales">
            </div>
        `;
    },

    /**
     * Genera el HTML para el formulario de nueva fuente.
     * @returns {string}
     */
    getSourceFormHtml: () => {
        return `
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="name">Nombre de la Fuente</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="name" name="name" type="text" required>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="initial_balance">Saldo Inicial</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="initial_balance" name="initial_balance" type="number" step="0.01" value="0" required>
            </div>
        `;
    }
};